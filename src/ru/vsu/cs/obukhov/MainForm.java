...
public class MainForm extends JFrame {
    ...
    private Timer timer = new Timer(1000, e -> {
        try {
            ...
            SwingUtils.showInfoMessageBox("Right", "Array sorted");
            stopTime();
        }
    });
    ...
    public MainForm(String title) {
        ...
        buttonPrevious.addActionListener(e -> {
            try {
                ...
                SwingUtils.showInfoMessageBox("Wrong", "You are back at the start of sorting");
                count = 0;
            }
        });
        ...
        solveButton.addActionListener(e -> {
            try {
                ...
                assert arr != null;
                states = new ArrayList<>(Sort.sort(arr));
                JTableUtils.writeArrayToJTable(tableOutput, states.get(count).getArr());
                tempJ = states.get(count).getTempJ();
                count++;
                timer.start();
